...
pub fn errorhandling() {
    ...
    for attempt in 1..=max_attempts {
        let read_path = get_input("Enter the path of the file to test reading: ");
    ...
    // 尝试写入文件
    for attempt in 1..=max_attempts {
        let write_path = get_input("Enter the path of the file to test writing: ");
    ...
    // 尝试追加到文件
    for attempt in 1..=max_attempts {
        let append_path = get_input("Enter the path of the file to test appendingss: ");
